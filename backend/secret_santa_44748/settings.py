"""
Django settings for secret_santa_44748 project.
...
ROOT_URLCONF = 'secret_santa_44748.urls'
...
WSGI_APPLICATION = 'secret_santa_44748.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "secret_santa_44748 API",
    "DESCRIPTION": "API documentation for secret_santa_44748 App",
    "VERSION": "v1",
}
